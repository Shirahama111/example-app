    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link class="text-white" :href="route('tweet.index')" :active="request()->routeIs('tweet.index')">
                       {{ __('Tweet') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="flex">
                ...
                <!-- login username -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex items-center text-white">User : {{ Auth::user()->name }}</div>

                <!-- profile -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link class="text-white" :href="route('profile.edit')" :active="request()->routeIs('profile.edit')">
                       {{ __('Profile') }}
                    </x-nav-link>
                </div>
